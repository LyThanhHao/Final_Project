                        ...
                        <form action="{{ route('check_change_profile') }}" method="POST">
                            ...
                            <div class="row gx-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="fullname" name="fullname" type="text" placeholder="Enter your fullname" value="{{ $user->fullname }}" required>
                                    @error('fullname')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="email" name="email" type="text" placeholder="name@gmail.com" value="{{ $user->email }}" required>
                                    @error('email')
                                    <small style="color: red;">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="row gx-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="address" name="address" type="text" placeholder="Enter your address" value="{{ $user->address }}" required>
                                    @error('address')
                                    <small style="color: red;">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="phoneNumber" name="phoneNumber" type="tex" placeholder="Enter your phone number" value="{{ $user->phoneNumber }}" required>
                                    @error('phoneNumber')
                                    <small style="color: red;">{{ $message }}</small>
                                    @enderror
                                </div>
