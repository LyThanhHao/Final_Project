    ...
    <body>
        <div class="container-xl mt-4">
            <div class="header-container">
                <img width="40" height="40" src="https://img.icons8.com/office/40/gender-neutral-user.png"
                    alt="" />
                <span style="font-weight: bold; text-align: center; font-size: 40px; color: #3936f6">Personal
                    Information</span>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="card mb-4 mb-md-0">
                        ...
                        <div class="card-body text-center">
                            <img class="img-account-profile rounded-circle mb-2"
                                src="{{ $user->avatar ? asset('uploads/avatar/' . $user->avatar) : asset('uploads/avatar/avatar_default.jpg') }}"
                                alt="Avatar">
                            <div class="small font-italic text-muted mb-2">JPG, PNG, JPEG, GIF, WEBP or SVG no larger than
                                20 MB</div>
