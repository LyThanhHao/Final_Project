...
<div class="message-card @if($isSender) mc-sender @endif" data-id="{{ $id }}">
    ...
    <div class="message-card-content">
        @if (@$attachment->type != 'image' || $message)
            <div class="message">
                {!! $message ? nl2br($message) : ($attachment->type != 'file' ? $attachment->title : '') !!}
                {!! $timeAndSeen !!}
        ...
        <div class="image-wrapper" style="text-align: {{$isSender ? 'end' : 'start'}}">
            <div class="image-file chat-image" style="background-image: url('{{ asset('uploads/chat_file/' . $attachment->file) }}')">
