...
return [
    ...
    */
    'user_avatar' => [
        'folder' => 'uploads/avatar', // Thư mục khớp với cấu trúc hiện tại
        'default' => 'avatar_default.jpg', // Avatar mặc định hiện tại
    ],
    ...
    */
    'attachments' => [
        'folder' => 'uploads/chat_file',
        'download_route_name' => 'attachments.download',
        'allowed_images' => (array) ['png', 'jpg', 'jpeg', 'gif'],
        'allowed_files' => (array) ['zip', 'rar', 'txt', 'pdf', 'doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx'],
